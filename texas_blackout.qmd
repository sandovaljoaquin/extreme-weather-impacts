...
find the areas that intersect with blackout raster outside 200m of highway

layer needs to be overlapped with areas non-highway that experienced a blackout

Use -\> st_intersection , st_within, st_contains

st_within and st_contains will return different output than st_intersection:

if home borders area of the blackout and is partly in, st_intersects will say that home will be affected.
